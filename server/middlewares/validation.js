...
const signUp = (req, res, next) => {
  const schema = Joi.object({
    name: validationObj({ 'string.base': 'Invalid type, your name must be a string', 'string.empty': 'Please enter your name' }),
    username: validationObj({ 'string.base': 'Invalid type, your username must be a string', 'string.empty': 'Please enter your username' }),
    ...
    lineManager: validationObj({ 'string.base': 'Invalid type, your line manager must be a string', 'string.empty': 'Please enter your line manager' })
  });
